...
################################################################################
USAGE="USAGE: enable_triggers.ksh [database]  accepts name of database"
USAGE2="The only option you have to include with this command database "
#if [ $# -lt 1 ]
#then
#   if [ $# -eq 0 ]
#   then
...
db2 "CALL trigtool.enable_trigger('WSCOMUSR','CIVI_ATTR')";
db2 "CALL trigtool.enable_trigger('WSCOMUSR','CIVD_ATTR')";
db2 "CALL trigtool.enable_trigger('WSCOMUSR','CIVU_ATTR')";

db2 "CALL trigtool.enable_trigger('WSCOMUSR','CIVI_ATTRVAL')";
db2 "CALL trigtool.enable_trigger('WSCOMUSR','CIVU_ATTRVAL')";

db2 "CALL trigtool.enable_trigger('WSCOMUSR','CIVI_ATTVALDSC')";
db2 "CALL trigtool.enable_trigger('WSCOMUSR','CIVU_ATTVALDSC')";
