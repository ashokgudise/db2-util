...
( select 
    ...
    total_cpu_time,
    rows_read,
    translate(substr(stmt_text,1,1000),' ',chr(10)) as stmt_text
  from
...
EXPORT TO first_executing_sqls.csv  OF DEL modified by timestampformat="YYYY/MM/DD HH:MM.SS.UUUUUU"
select ts, coord_member, application_handle,elapsed_time_sec, activity_state, total_cpu_time, rows_read, stmt_text
from mon_current_sql_start ;

### VALUES ('ts','coord_member','handle','elapsed_s','state','total_cpu_time','rows_read','stmt_text');
...
EXPORT TO second_executing_sqls.csv  OF DEL modified by timestampformat="YYYY/MM/DD HH:MM.SS.UUUUUU"
select ts, coord_member, application_handle,elapsed_time_sec, activity_state, total_cpu_time, rows_read, stmt_text
from mon_current_sql_end ;
