...
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" >> $LOGFILE
echo "SECTION Q:  INSTANCE LIST and CONNECTION COUNT" >> $LOGFILE
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" >> $LOGFILE
echo " " >> $LOGFILE

db2instance -list > $LOGFILE
/home/db2inst1/member_count.ksh >> $LOGFILE
echo " " >> $LOGFILE

echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" >> $LOGFILE
echo "SECTION R:  DIAG LOG ERRORS LIST AND COUNT" >> $LOGFILE
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" >> $LOGFILE
echo " " >> $LOGFILE

/db2shared/db2scripts/QBSCRIPTS/script_diag_list.sh >> $LOGFILE
echo " " >> $LOGFILE
